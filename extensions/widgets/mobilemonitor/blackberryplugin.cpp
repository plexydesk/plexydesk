...
void BlackBerryPlugin::onPinCanceled() { d->mPaneView->pop(); }
...
QObject *BlackBerryPlugin::defaultView() { return d->mPaneView; }
...
void BlackBerryPlugin::requestAction(const QString &actionName,
