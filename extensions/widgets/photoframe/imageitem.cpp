...
void ImagePileWidget::paintExtFace(QPainter * /*p*/,
...
QRectF ImagePileWidget::boundingRect() const { return boundingRect(); }

void ImagePileWidget::setCoverPic(QImage img) { cover = img; }
