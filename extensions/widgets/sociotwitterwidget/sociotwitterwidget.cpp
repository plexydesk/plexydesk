...
/*
    ...
    {
        scrollArea->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QScrollArea {\n"
   " border: 2px solid #8f8f91;     \n"
   " border-radius: 6px;      \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        graphicsView->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QGraphicsView{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        graphicsView_2->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QGraphicsView{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   ...
   "", 0, QApplication::UnicodeUTF8));
        graphicsView_3->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QGraphicsView{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        graphicsView_4->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QGraphicsView{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        graphicsView_5->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QGraphicsView{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        textBrowser->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QTextBrowser{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        textBrowser_2->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QTextBrowser{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        textBrowser_3->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QTextBrowser{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        textBrowser_4->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QTextBrowser{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        textBrowser_5->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QTextBrowser{\n"
   " border: 0.5px solid #8f8f91; \n"
   "border-color: #006699;    \n"
   " border-radius: 5px;       \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        pushButton->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QPushButton {\n"
   " border: 1px solid #8f8f91;     \n"
   " border-radius: 6px;     \n"
   " background-image:url(blue.png);\n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        pushButton->setText(QApplication::translate("SocioTwitterClass", "Home",
   0, QApplication::UnicodeUTF8));
        OPtions->setStyleSheet(QApplication::translate("SocioTwitterClass",
   "QPushButton {\n"
   " border: 1px solid #8f8f91;     \n"
   " border-radius: 3px;     \n"
   " background-image:url(blue.png);  \n"
   " min-width: 25px; }", 0, QApplication::UnicodeUTF8));
        OPtions->setText(QApplication::translate("SocioTwitterClass", "Options",
   0, QApplication::UnicodeUTF8));
...
void SocioTwitterwidget::setPath(QString str) { prefix = str + "/"; }

void SocioTwitterwidget::drawWidget() {}
}
