...
void WidgetItem::paintExtFace(QPainter *p, const QStyleOptionGraphicsItem *e,
  ...
  /*
     ...
     |QPainter::Antialiasing |QPainter::HighQualityAntialiasing);
          ...
          {
          p->drawText(QRect(10,10,160,160), Qt::AlignTop
     ,QDate::longDayName(QDate::currentDate().dayOfWeek ())  ) ;
          p->setFont(QFont("Bitstream Charter",50));
          p->drawText(QRect(40,40,160,160), Qt::AlignTop
     ,QString("%1").arg(QDate::currentDate().day() )  )  ;
          }
   */
}
...
void WidgetItem::paintExtDockFace(QPainter *p,
  ...
  p->drawText(QRect(20, 25, 160, 160), Qt::AlignTop,
              QDate::shortMonthName(QDate::currentDate().month()));

  p->setPen(QColor(0, 0, 255));
  p->setFont(QFont("Bitstream Charter", 50));
  p->drawText(QRect(20, 40, 160, 160), Qt::AlignTop,
              QString("%1").arg(QDate::currentDate().day()));

  //  p->drawText(QRect(8,5,64,64), Qt::AlignCenter ,"Calendar" ) ;
}

QRectF WidgetItem::boundingRect() const { return rect(); }
