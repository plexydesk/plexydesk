...
void Frame::paint(QPainter *painter, const QStyleOptionGraphicsItem *option,
  ...
  /*
     ...
     //  painter->fillRect( QRectF(6,6,r.width()-14,r.height()-14)
     ,QColor(0,0,0));
      painter->restore ();
      //painter->translate(0.5,0.5);
      QPixmap top ( QSize(render.boundsOnElement("g3329").width(),
     render.boundsOnElement("g3329").height()  ));
      ...
      QPixmap left (QSize(render.boundsOnElement("g3335").width(),
     render.boundsOnElement("g3335").height()));
