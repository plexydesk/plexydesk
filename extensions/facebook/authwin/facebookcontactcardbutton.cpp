...
void FacebookContactCardButton::paintNormalButton(
  ...
  if (style()) {
    style()->paintControlElement(PlexyDesk::Style::CE_PushButton, feature,
                                 painter);
    style()->paintControlElementText(PlexyDesk::Style::CE_PushButton, feature,
                                     label(), painter);
  }
}
