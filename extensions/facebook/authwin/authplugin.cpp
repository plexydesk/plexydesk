  ...
  : PlexyDesk::ControllerInterface(object)
{
  ...
  connect(mWidget, SIGNAL(facebookToken(QString)), this,
          SLOT(onFacebookToken(QString)));
  ...
  mContactUI->setWidgetFlag(PlexyDesk::DesktopWidget::TOP_LEVEL_WINDOW);

  connect(mContactUI, SIGNAL(addContactCard(QString)), this,
          SLOT(onAddContactCard(QString)));
