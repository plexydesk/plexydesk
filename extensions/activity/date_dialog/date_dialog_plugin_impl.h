...
*******************************************************************************/
#ifndef DATEPICKER_DATA_I
#define DATEPICKER_DATA_I
...
class date_dialog_plugin_impl : public QObject,
                            public cherry_kit::dialog_plugin_interface {
  Q_OBJECT
  Q_INTERFACES(cherry_kit::dialog_plugin_interface)
  Q_PLUGIN_METADATA(IID "org.qt-project.date_dialog")

public:
  virtual ~date_dialog_plugin_impl() {}
