...
class PlexyWindows : public PlexyDesk::AbstractDesktopWidget {
  Q_OBJECT
public:
  PlexyWindows(Display *d, Window w, XWindowAttributes *attr,
  ...
  void Configured(bool isNotify, int x, int y, int width, int height,
                  int border, PlexyWindows *aboveWin, bool override_redirect);
