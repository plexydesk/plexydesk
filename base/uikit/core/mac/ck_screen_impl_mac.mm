...
float cherry_kit::screen::platform_screen::scale_factor(int a_display_id) const
{
  return 2.0f;
}
...
float cherry_kit::screen::platform_screen::display_width(int a_display_id) const
{
  return 1440.0f;
}

float cherry_kit::screen::platform_screen::display_height(int a_display_id) const
{
  return 900.0f;
}
