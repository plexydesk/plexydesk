...
/**
  ...
  *UI::TableView
    */
class DECL_UI_KIT_EXPORT table_model : public QObject {
  Q_OBJECT
...
public:
  ...
  /**
      ...
      */
  table_model(QObject *a_parent_ptr = 0);
...
Q_SIGNALS:
  ...
  void add(cherry_kit::table_view_item *a_item_ptr);

  void removed(cherry_kit::table_view_item *a_item_ptr);
