...
#define glGenerateMipmap                                                       \
  ((type_glGenerateMipmap)QGLContext::currentContext()->getProcAddress(        \
      QLatin1String("glGenerateMipmap")))
#define glVertexAttribPointer                                                  \
  ((type_glVertexAttribPointer)QGLContext::currentContext()->getProcAddress(   \
      QLatin1String("glVertexAttribPointer")))
